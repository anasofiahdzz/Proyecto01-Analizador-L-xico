...
-- Se importa la definición del tipo Expr.
import ER 
...
type Estado = String
-- Definición de una transición que podría ser con símbolo o con epsilon. 
...
-- ### Función azúcar sintactica, que convierte una ER a AFNepsilon ###
...
expr_to_AFNEp (Term c) edoNuevo =
    let q0 = estadoNuevo edoNuevo -- Estado inicial q0.
